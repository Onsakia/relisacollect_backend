...
Includes: Auth, Plots, Trees, Soil, Water, Socio-Economic, Stats, Uploaded Layers.
"""
...
from collect.views import (
    ...
    StatsViewSet, UploadedLayerViewSet,
    login_view, register_view, me_view,
)
...
router.register(r'layers', UploadedLayerViewSet, basename='layer')
